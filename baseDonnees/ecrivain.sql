...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 18 jan. 2018 à 21:22
...
--
-- CREATE DATABASE IF NOT EXISTS `ecrivain` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
-- USE `ecrivain`;
...
(8, 'SÃ©lectionnez le message Ã  modifier Ã  gauche puis effectuez vos modifications avant de choisir l\'opÃ©ration dÃ©sirÃ©e.', 'askCRUDMessage', 0, 1),
...
(14, 'Bonjour Ã  toutes et Ã  tous et bienvenue dans mon nouveau roman. Vous y dÃ©couvrirez mon dernier pÃ©riple en Alaska.', '_messageView', 0, 1),
...
--
-- Structure de la table `typemessage`
--
...
--
-- Déchargement des données de la table `typemessage`
--
...
(4, 'maxou2', '0a1c643a4b76c377b5d82dcf4e42c968834cfae848c3b1e73e3b2cffebceeffb', 'maison.public32@gmail.com', 1, 99),
(5, 'maxou', 'a4f6d52622dcbaa66895b643795820f81b69cbff04bc82c7d756172f50ce3f7b', 'public@gmail.com', 2, 99),
(11, 'albert', '72d0166b5707d129dc321e56692fe454c034552ee9e2b38f5a7f1c1306a632ea', 'albert@albert.moi', 2, 2);
...
--
-- Index pour la table `typemessage`
--
...
--
ALTER TABLE `TP04_chapters`
  MODIFY `idchapters` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
